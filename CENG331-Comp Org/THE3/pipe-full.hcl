...
#               #                                                  #
####################################################################
# Added LEAQ instruction to pipe-full.hcl
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IICMPQ, ILEAQ };					#add ILEAQ to valid instructions
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
		     IIRMOVQ, IRMMOVQ, IMRMOVQ, IICMPQ, ILEAQ  };					#ILEAQ requires regid byte (apparent from the encoding)

# Does fetched instruction require a constant word?
bool need_valC =
	f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IICMPQ, ILEAQ  };			#ILEAQ requires constant word as apparent from the encoding
...
word d_srcB = [
	D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IICMPQ, ILEAQ   } : D_rB;				#ILEAQ Added here since, valB <- R[ rB ] 
...
word d_dstE = [
	...
	D_icode in { ILEAQ } : D_rA;									#ILEAQ Added here since, R[ rA ] <- valE
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IICMPQ, ILEAQ  } : E_valC;				#ILEAQ Added here since, valE <- valB + valC
...
E_icode in { IRMMOVQ, IMRMOVQ, IOPQ, ICALL, IICMPQ,
		     IPUSHQ, IRET, IPOPQ, ILEAQ } : E_valB;						#ILEAQ Added here since, valE <- valB + valC
	E_icode in { IRRMOVQ, IIRMOVQ } : 0;
	# Other instructions don't need ALU
];

## Set the ALU function										#default taken which is "+" for ILEAQ
word alufun = [
	E_icode == IOPQ : E_ifun;
