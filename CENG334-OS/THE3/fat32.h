...
typedef struct struct_BPBFAT32_struct { //Size of struct == 26 bytes
...
typedef struct struct_BPB_struct {  //Size of struct == 27 + 26 = 53 bytes
...
typedef struct struct_FatFile83 {   //Size of struct == 23 bytes
...
typedef struct struct_FatFileLFN { //Size of struct == 10 bytes
